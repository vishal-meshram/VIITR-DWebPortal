			...
			<div class="col-sm-12"> <!-- First column in the Row-->
				...
				<div class="widget-box"> <!-- Widget Box starts here -->
					<div class="widget-header"> <!-- Widget Header -->
						<h4 class="widget-title">IPR Information</h4>
					</div>
					...
					<!-- Form Starts Here -->
						<form action="includes/papers_inc.php" method="POST" enctype="multipart/form-data">
							...
							<fieldset id="field">
								<div id="author">
									<div>
										<label class="col-sm-12 bolder brown">IPR Authors Information:</label>
									</div>
									<br>
									<hr>
									...
									<div class="row"> <!-- Third row of authors information statrs here -->
										<div class="space-6"></div>
											<div class="col-sm-3">	
											<a href="#" id="addcoauthor"> <span class="label label-xlg label-yellow arrowed arrowed-right">+ Add IPR Co-Author</span></a>
										</div>
								...
								<div>
									<label class="col-sm-12 bolder brown">IPR Details:</label>
								</div>
								<br>
								<hr>
								<div class="row"> <!-- First row of Journal information starts here-->
									...
									<div class="col-sm-4">
										<label  class="control-label">IPR Status : </label>
								...
								<br>
									<div class="col-sm-4">	
										<label>Date of IPR published: </label>
										<div>
