			...
			<div class="col-sm-12"> <!-- First column in the Row-->
				...
				<div class="widget-box"> <!-- Widget Box starts here -->
					<div class="widget-header"> <!-- Widget Header -->
						<h4 class="widget-title">Lab Development Information</h4>
					</div>
				...
				<div class="widget-body"> <!-- Widget Body -->
					...
					<!-- Form Starts Here -->
						<form class="signup-form" action="includes/papers_inc.php" method="POST" enctype="multipart/form-data">
							...
							<fieldset>
								<div>
									<label class="col-sm-12 bolder brown">Authers Information:</label>
								</div>
								<br>
								<hr>
								...
								<div class="row"> <!-- First row of authors information starts here-->
									<div class="col-sm-4">									
										...
										<input type="number" name="empid" value='<?php echo $_SESSION['session_empNo'] ?>'  />
									</div>
									<div class="col-sm-4">	
										<label>First Name: </label>
										<input type="text" name="firstname" value='<?php echo $_SESSION['session_empFirstName']?>' />
									</div>
									<div class="col-sm-4">									
										<label>Last Name: </label>
										<input type="text" name="lastname" value='<?php echo $_SESSION['session_empLastName']?> ' />
									</div>
								...
								<div class="row"> <!-- Second row of authors information starts here-->
									<div class="col-sm-4">									
										<label>Email: </label>
										<input type="text" name="email" value='<?php echo $_SESSION['session_empEmail'] ?>'  />
									</div>
									<div class="col-sm-8">	
										<label>Department: </label>
										<input type="text" name="department" value='<?php echo $_SESSION['session_empDepartment'] ?>' />
									</div>
								...
								<div class="row"> <!-- First row of Journal information starts here-->
									<div class="col-sm-4">	
										...
										<input type="text" name="journalname" placeholder="Enter Journal name here.." />
									</div>
									<div class="col-sm-4">									
										<label>ISSN/ISBN No: </label>
										<input type="text" name="journalnumber" placeholder="ISSN / ISBN Number" />
									</div>
									<div class="col-sm-4">									
										<label>Impact Factor: </label>
										<input type="text" name="impactfactor" placeholder="Enter Ymapct Factor of Journal" />
									</div>
								</div> <!-- First row of Journal information ends here-->
								<br>
								<div class="row"> <!-- Second row of Journal information starts here-->
									<div class="col-sm-4">
										<label  class="control-label">Journal is Unpaid : </label>
											<div class="radio">
												<label>
													<input name="unpaid" type="radio" class="ace" value="yes"/>
													<span class="lbl"> Yes </span>			
												</label>
											</div>
											<div class="radio">
												<label>
													<input name="unpaid" type="radio" class="ace" value="no"/>
