			...
			<div class="col-sm-12"> <!-- First column in the Row-->
				...
				<div class="widget-box"> <!-- Widget Box starts here -->
					<div class="widget-header"> <!-- Widget Header -->
						<h4 class="widget-title">MOU Information</h4>
					</div>
						...
						<form class="signup-form" action="includes/papers_inc.php" method="POST" enctype="multipart/form-data">
							...
							<fieldset>
								<div class="row"> <!-- First row of paper publication information starts here-->
									<div class="col-sm-4">	
										<label>Mou Signed Wirh: </label>
										<input type="text" name="mouparty" placeholder="Enter name of MOU signed with " />
									</div>
									<div class="col-sm-4">
										<label>MOU No</label>
										<input type="text" name="mounumber" placeholder="Enter mou number" />
									</div>
									<div class="col-sm-4">	
										<label>Date of MOU: </label>
										<div class="col-xs-8 col-sm-11">
											<div class="input-group">
												<input class="form-control date-picker" id="id-date-picker-1" name="moudate" type="text" data-date-format="dd-mm-yyyy" />
								...
								<div class="row"> <!-- Second row of paper publication information starts here-->
									<div class="col-xs-4">
										<label>Upload MOU document</span></label>
										<input type="file" name="mouletter" id="id-input-file-2" />
									</div>	
