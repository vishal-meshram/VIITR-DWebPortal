			...
			<div class="col-sm-12"> <!-- First column in the Row-->
				...
				<div class="widget-box"> <!-- Widget Box starts here -->
					<div class="widget-header"> <!-- Widget Header -->
						<h4 class="widget-title">Patent Information</h4>
					</div>
					...
					<!-- Form Starts Here -->
						<form action="includes/papers_inc.php" method="POST" enctype="multipart/form-data">
							...
							<fieldset id="field">
								<div id="author">
									<div>
										<label class="col-sm-12 bolder brown">Authors Information:</label>
									</div>
									<br>
									<hr>
									...
									<div class="row"> <!-- Third row of authors information statrs here -->
										<div class="space-6"></div>
											<div class="col-sm-3">	
											<a href="#" id="addcoauthor"> <span class="label label-xlg label-yellow arrowed arrowed-right">+ Add Patent Co-Author</span></a>
										</div>
								...
								<div>
									<label class="col-sm-12 bolder brown">Patent Details:</label>
								</div>
								<br>
								<hr>
								<div class="row"> <!-- First row of Journal information starts here-->
									<div class="col-sm-4">	
										...
										<input type="text" name="iprtitle" placeholder="Enter IPR Title here" />
									</div>

									<div class="col-sm-4">									
										<label>Patent No: </label>
										<input type="text" name="iprnumber" id="iprnumber" placeholder="IPR Number" />
									</div>
									<div class="col-sm-4">
										<label  class="control-label">Patent Status : </label>
											<div class="radio-inline">
												<label>
													<input name="status" type="radio" class="ace" value="national"/>
													<span class="lbl"> National </span>			
												</label>
											
												<label>
													<input name="status" type="radio" class="ace" value="international"/>
								...
								<br>
									<div class="col-sm-4">	
										<label>Date of Patent published: </label>
										<div>
									...
									<div class="col-xs-4">
										<label>Upload Soft copy of Patent here..</span></label>
...
<![endif]-->
		...
		<script src="src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
