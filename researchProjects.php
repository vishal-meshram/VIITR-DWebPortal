			...
			<div class="col-sm-12"> <!-- First column in the Row-->
				...
				<div class="widget-box"> <!-- Widget Box starts here -->
					<div class="widget-header"> <!-- Widget Header -->
						<h4 class="widget-title">Funded Research Projects Information</h4>
					</div>

				<div class="widget-body"> <!-- Widget Body -->
					<div class="widget-main no-padding">
					<!-- Form Starts Here -->
						<form class="signup-form" action="includes/papers_inc.php" method="POST" enctype="multipart/form-data">
							<!-- <legend>Form</legend> -->
										
							<fieldset>
								<div id="PI">
									<div>
										<label class="col-sm-12 bolder brown">PI Information:</label>
									</div>
									<br>
									<hr>
									...
									<div class="row"> <!-- First row of authors information starts here-->
										<div class="col-sm-3">									
										 ...
										 <select>
											  ...
											  <option value="PI">Principal Investegator</option>
											  <option value="CO-PI">CO-Principal Investegator</option>
										</select> 
									</div>
									...
									<div class="row"> <!-- Third row of authors information statrs here -->
										<div class="space-6"></div>
											<div class="col-sm-3">	
											<a href="#" id="addPI"> <span class="label label-xlg label-yellow arrowed arrowed-right">+ Add Co-PI</span></a>
										</div>
								...
								<div>
									<label class="col-sm-12 bolder brown">Funding Agency Details:</label>
								</div>
								<br>
								<hr>
								<div class="row"> <!-- First row of Journal information starts here-->
									<div class="col-sm-4">	
										...
										<input type="text" name="fundaingagencyname" placeholder="Enter Journal name here.." />
									</div>
									<div class="col-sm-4">									
										<label>Funding Agency Type: </label>
										 <select>
											  <option value="externalagency">External Funding Agency</option>
											  <option value="universityagency">University Agency</option>
											  <option value="internalagency">Internal Funding Agency</option>
										</select> 
									</div>
								...
								<hr>
								<div>
									<label class="col-sm-12 bolder brown">Research Project Details:</label>
								</div>
								<br>
								<hr>
								<div class="row"> <!-- First row of paper publication information starts here-->
									...
									<div class="col-sm-4">
										<label>Proposal Id No</label>
										<input type="text" name="sanctionedno" placeholder="Enter project sanctioned no.." />
									</div>
									<div class="col-sm-4">
										<label>Amount Sanctioned</label>
										<input type="text" name="amount" placeholder="Enter amount sanctioned" />
									</div>
								...
								<div class="row"> <!-- Second row of paper publication information starts here-->
									<div class="col-sm-4">	
										<label>Date of Project Sanctioned: </label>
								...
								<div class="col-xs-4">
									<label>Upload Project Santioned Letter..</span></label>
									<input type="file" name="projectsanctionedletter" id="id-input-file-2" />
								</div>	
									...
									<div class="col-sm-4">
										<label  class="control-label">Project Status: </label>
											<div class="radio-inline">
												<label>
													<input name="projectstatus" type="radio" class="ace" value="yes"/>
													<span class="lbl"> Ongoing </span>			
												</label>
											</div>
											<div class="radio-inline">
												<label>
													<input name="projectstatus" type="radio" class="ace" value="no"/>
