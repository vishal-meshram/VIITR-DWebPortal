			...
			<div class="col-sm-12"> <!-- First column in the Row-->
				...
				<div class="widget-box">
					<div class="widget-header">
						<h4 class="widget-title">Publication Reports Forms</h4>
					</div>
						...
						<div class="widget-main">
							<form class="form-inline">
								...
								<div class="row">
									...
									<div class="col-sm-2"> <!-- submit button div starts here -->
										<div class="space"></div>
										<button type="submit" class="btn btn-sm btn-success" name="submit">Submit<i 	class="ace-icon fa fa-arrow-right icon-on-right bigger-110"></i>	</button><!-- Submit Button ends here -->
									</div> <!-- submit button div ends here -->
				...
				<div class="hr hr-18 dotted hr-double"></div>
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<h4 class="pink">
										<i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i> Paper Publication Report is here...
										</h4>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td> <?php echo $row['pub_paperTitle']; ?></td>
														<td> <?php echo $row['pub_publicationDate']; ?></td>
