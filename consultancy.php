			...
			<div class="col-sm-12"> <!-- First column in the Row-->
				...
				<div class="widget-box"> <!-- Widget Box starts here -->
					<div class="widget-header"> <!-- Widget Header -->
						<h4 class="widget-title">Consultancy Information</h4>
					</div>
						...
						<form class="signup-form" action="includes/papers_inc.php" method="POST" enctype="multipart/form-data">
							...
							<fieldset>
								...
								<div class="row"> <!-- First row of Journal information starts here-->
									<div class="col-sm-4">	
										<label>Title of Consultancy: </label>
										<input type="text" name="consultancytitle" placeholder="Enter Consultancy Title here.." />
									</div>
									<div class="col-sm-4">									
										<label>Consultancy Amount: </label>
										<input type="text" name="consultancyamount" placeholder="Enter the Consultancy genrated" />
									</div>
									<div class="col-sm-4">									
										<label>Consultancy Done for: </label>
										<input type="text" name="consultnacydonefor" placeholder="Consultancy done for..." />
									</div>
								</div> <!-- First row of Journal information ends here-->
								<br>
								<div class="row"> <!-- Second row of Journal information starts here-->
									<div class="col-sm-4">
										<label  class="control-label">Social Relevance: </label>
											<div class="radio-inline">
												<label>
													<input name="socialrelevance" type="radio" class="ace" value="yes"/>
													<span class="lbl"> Yes </span>			
												</label>
											</div>
											<div class="radio-inline">
												<label>
													<input name="socialrelevance" type="radio" class="ace" value="no"/>
									...
									<div class="col-sm-6">	
										<label>Select the Consultancy Duration:</label>
										<div class="input-daterange input-group">
											<input type="text" class="input-sm form-control" name="consultancystartdate" placeholder="Start Date"/>
											<span class="input-group-addon"><i class="fa fa-exchange"></i>
											</span>
											<input type="text" class="input-sm form-control" name="consultancyenddate" placeholder="End Date"/>
											</div>
										</div>									
									</div>
								<div class="row">
									<div class="col-xs-6">
										<label>Upload Consultancy document Here..</span></label>
										<input type="file" name="consultancycertificate" id="id-input-file-2"/>
									</div>
								</div>
