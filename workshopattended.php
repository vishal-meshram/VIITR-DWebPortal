			...
			<div class="col-sm-12"> <!-- First column in the Row-->
				...
				<div class="widget-box"> <!-- Widget Box starts here -->
					<div class="widget-header"> <!-- Widget Header -->
						<h4 class="widget-title">Workshop Attended</h4>
					</div>
				...
				<div class="widget-body"> <!-- Widget Body -->
					...
					<!-- Form Starts Here -->
						<form action="includes/papers_inc.php" method="POST" enctype="multipart/form-data">
							...
							<fieldset>
								<div>
									<label class="col-sm-12 bolder brown">Workshop Information:</label>
								</div>
								<br>
								<hr>
								<div class="row"> <!-- First row of Workshop information starts here-->
									<div class="col-sm-4">	
										<label>Workshop Title: </label>
										<input type="text" name="workshoptitle" placeholder="Enter Workshop Title.." />
									</div>
									<div class="col-sm-4">	
										<label>Organized By: </label>
										<input type="text" name="organizedby" placeholder="Organized By..." />
									</div>									
									<div class="col-sm-4">									
										<label>Venue: </label>
										<input type="text" name="workshopvenue" placeholder="Enter the venue/City.." />
									</div>
									
								</div> <!-- First row of workshop information ends here-->
								<br>
								<div class="row"> <!-- Second row of workshop information starts here-->
									<div class="col-sm-4">
										<label  class="control-label">Sponcered By College : </label>
											<div class="radio-inline">
												<label>
													<input name="sponceredbycollege" type="radio" class="ace" value="yes"/>
													<span class="lbl"> Yes </span>			
												</label>
											</div>
											<div class="radio-inline">
												<label>
													<input name="sponceredbycollege" type="radio" class="ace" value="no"/>
									...
									<div class="col-sm-4">									
										...
										<input type="text" name="workshopfees" placeholder="Enter the Fees paid" />
									</div>	
									<div class="col-sm-4">	
										<label>Select the Workshop Dates:</label>
										<div class="input-daterange input-group">
											<input type="text" class="input-sm form-control" name="workshopstartdate" placeholder="Start Date"/>
											<span class="input-group-addon"><i class="fa fa-exchange"></i>
											</span>
											<input type="text" class="input-sm form-control" name="workshopenddate" placeholder="End Date"/>
											</div>
										</div>									
									</div><!-- Second row of workshop information ends here-->		
								
								<div class="row"><!-- Third row of workshop information starts here-->
									<div class="col-sm-4">	
										<label>Total No. of Days: </label>
										<input type="text" name="noofdays" placeholder="Enter Total No. of days.." />
									</div>
									<div class="col-xs-6">
										<label>Upload Workshop Certificate Here..</span></label>
										<input type="file" name="workshopcertificate" id="id-input-file-2"/>
									</div>
								</div><!-- Third row of workshop information ends here-->
