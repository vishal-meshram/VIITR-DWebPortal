			...
			<div class="col-sm-12"> <!-- First column in the Row-->
				...
				<div class="widget-box"> <!-- Widget Box starts here -->
					<div class="widget-header"> <!-- Widget Header -->
						<h4 class="widget-title">Publication In Journal Information</h4>
					</div>
					...
					<!-- Form Starts Here -->
						<form action="includes/papers_inc.php" method="POST" enctype="multipart/form-data">
							...
							<fieldset id="field">
								...
								<div>
									<label class="col-sm-12 bolder brown">Journal Information:</label>
								</div>
								<br>
								<hr>
								<div class="row"> <!-- First row of Journal information starts here-->
									<div class="col-sm-3">	
										<label class="control-label col-sm-8 no-padding-right" for="journalname">Name of the Journal: </label>
										<input type="text" name="journalname" id="journalname" placeholder="Enter Journal name here.." />
									</div>

									<div class="col-sm-3">									
										<label class="control-label col-sm-7 no-padding-right" for="journalnumber" >ISSN/ISBN No: </label>
										<input type="text" name="journalnumber" id="journalnumber"placeholder=" ISSN or ISBN Number" />
									</div>
								
									<div class="col-sm-3">									
										<label class="control-label col-sm-7 no-padding-right" for="impactfactor">Impact Factor: </label>
								...
								<div class="row"> <!-- Second row of Journal information starts here-->
										<div class="col-sm-6">
											<label class="control-label col-sm-3 no-padding-right" for="unpaid">Journal is Unpaid:</label>
												<label class="line-height-1 blue  no-padding-right">
